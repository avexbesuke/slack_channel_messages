...
require 'slack_channel_messages/version'
...
Gem::Specification.new do |spec|
  spec.name          = 'slack_channel_messages'
  spec.version       = SlackChannelMessages::VERSION
  spec.required_ruby_version = '>= 2.5'
  spec.authors       = ['avexbesuke']
  spec.email         = ['kousinetu3400@gmail.com']

  spec.summary       = 'CLI tool to summarize slack channel stats'
  spec.description   = 'CLI tool to summarize slack channel stats'
  spec.homepage      = 'https://github.com/avexbesuke/slack_channel_messages'
  spec.license       = 'MIT'
